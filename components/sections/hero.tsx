...
const heroImages = [
  'https://res.cloudinary.com/dlctwbems/image/upload/v1781173997/ChatGPT_Image_Jun_11_2026_11_32_18_AM.png',
  '/gallery-1.png',
  '/gallery-2.png',
  '/gallery-3.png',
  '/gallery-4.png',
  ...
  return (
    <section className="relative min-h-screen bg-[#050505] overflow-hidden flex items-center pt-24 pb-16">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        {heroImages.map((src, index) => {
          ...
          return (
            ...
            >
              ...
              <img
                src={src}
                alt={`Pinnacle Culinary Academy hero background ${index + 1}`}
                className={`w-full h-full object-cover object-center transition-transform duration-[5500ms] ease-out ${isActive ? 'scale-110' : 'scale-100'
                  }`}
              />
            </div>
          )
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#050505] via-[#050505]/70 to-[#050505]/25 z-20" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(5,5,5,0)_50%,rgba(5,5,5,0.92)_90%)] z-20" />

        {/* Soft glowing ambient orbs */}
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#700200]/10 rounded-full blur-[120px] animate-float pointer-events-none z-20" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-[#aa7217]/5 rounded-full blur-[100px] animate-float pointer-events-none z-20" style={{ animationDelay: '3s' }} />
      </div>
      ...
      <div className="absolute bottom-6 md:bottom-[-20px] left-1/2 transform -translate-x-1/2 z-20 flex flex-col items-center gap-2">
